...
<body style="color: var(--bs-gray-900);">
    ...
    <h1 style="font-family: Acme, sans-serif;color: var(--bs-body-bg);font-size: 36px;background: var(--bs-pink);">Recipes</h1>
    <div class="text-center"></div>
    <div class="row">
        <div class="col-md-10 offset-md-1">
            <div class="card m-auto" style="max-width:850px">
                <div class="card-body">
                    <form class="d-flex align-items-center" action="searchRecipe.php">
                        <input class="form-control form-control-lg flex-shrink-1 form-control" type="search" placeholder="Search topics or keywords" name="searchbar" style="border-width: 2px;border-color: var(--bs-pink);border-radius: 24px;">
                        <button class="btn btn-success btn-lg" type="submit" style="font-size: 16px;font-family: Acme, sans-serif;color: var(--bs-gray-100);background: var(--bs-pink);border-radius: 36px;margin-left:10px;">Search</button>
                    </form>
                </div>
            </div>
        </div>
    ...
    <?php
        ...
        // query execution
        $query = "select id,username,title,descp,url from addreceipe";
