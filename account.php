...
<body>
    ...
    <?php
        ...
        echo "    
            ...
            <div><img class='rounded-circle 'style='margin-top:-70px;' src='assets/img/avatar7.png' height='150px'>
                <h3 style='font-family: Acme, sans-serif;color: var(--bs-pink);font-size:24px;'>".$name."</h3>
    ...
    <h1 style="font-family: Acme, sans-serif;font-size: 36px;background: var(--bs-pink);color: var(--bs-body-bg);">My Recipes</h1>
    ...
    <?php
        ...
        $queryn = "select * from addreceipe where username='$name'";
    ...
    <p style="font-family: 'Source Sans Pro', sans-serif;font-size: 16px;text-align: justify;margin-top:16px;"></p>
